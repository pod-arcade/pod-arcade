...
var nackPackets = metrics.GlobalMetricCache.GetCounter("nack_requests", prometheus.Labels{})
var nacksSuccessful = metrics.GlobalMetricCache.GetCounter("nacks_sent", prometheus.Labels{"error": "none"})
var nacksMissing = metrics.GlobalMetricCache.GetCounter("nacks_sent", prometheus.Labels{"error": "missing_packet"})
var nacksFailed = metrics.GlobalMetricCache.GetCounter("nacks_sent", prometheus.Labels{"error": "failed_to_send"})
